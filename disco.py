...
try:
    ...
    save_models_to_google_drive = True
except:
    is_colab = False
    google_drive = False
...
# fantasy26, "512x512_diffusion_uncond_finetune_008100" #@param ["256x256_diffusion_uncond", "512x512_diffusion_uncond_finetune_008100", "portrait_generator_v001", "pixelartdiffusion_expanded", "pixel_art_diffusion_hard_256", "pixel_art_diffusion_soft_256", "pixelartdiffusion4k", "watercolordiffusion_2", "watercolordiffusion", "PulpSciFiDiffusion", "custom"]
diffusion_model = "IsometricDiffusionRevrart512px"
...
# The following defaults will work on an 8GB card such as 2080S or 3060 Ti with resolution 1024x576
use_checkpoint = True #@param {type: 'boolean'}
ViTB32 = True #True #@param{type:"boolean"}
RN50 = True #True #@param{type:"boolean"}
RN101 = False #True #@param{type:"boolean"}
ViTB16 = True #True #@param{type:"boolean"}
RN50x4 = False #@param{type:"boolean"}
RN50x16 = False #nope True #@param{type:"boolean"}
RN50x64 = False #@param{type:"boolean"}
ViTL14 = False #nope True #@param{type:"boolean"}
ViTL14_336px = False #nope True #@param{type:"boolean"}
...
diff_model_map = {
    ...
    'lapelpindiffusion': { 'downloaded': False, 'sha': '80ce8322d502dac7a531bc6d82ade07a76e1d6770586ba9ecbaca11c77a71bc3', 'uri_list': ['https://huggingface.co/KaliYuga/lapelpindiffusion/resolve/main/lapelpindiffusion.pt'] },
...
elif diffusion_model == 'DifnesFusion2_160k':
    model_config.update({
...
elif diffusion_model == 'DifNESFusion_350k_NES':
    model_config.update({
          'attention_resolutions': '16',
          'class_cond': False,
          'diffusion_steps': 1000,
...
elif diffusion_model == 'DifNESFusion_200k_NES':
    model_config.update({
          'attention_resolutions': '16',
          'class_cond': False,
          'diffusion_steps': 1000,
...
elif diffusion_model == 'fantasy26':
    model_config.update({
        'attention_resolutions': '16',
        'class_cond': False,
        'diffusion_steps': 1000,
...
elif diffusion_model == 'FeiArt-Handpainted-CG-Diffusion':
  model_config.update({
          'attention_resolutions': '32,16,8',
          'class_cond': False,
          'diffusion_steps': 1000,
...
elif diffusion_model == 'IsometricDiffusionRevrart512px':
  model_config.update({
          'attention_resolutions': '32,16,8',
          'class_cond': False,
          'diffusion_steps': 1000,
...
elif diffusion_model == 'lithographydiffusion':
    model_config.update({
          'attention_resolutions': '16',
          'class_cond': False,
          'diffusion_steps': 1000,
...
elif diffusion_model == 'medievaldiffusion':
    model_config.update({
          'attention_resolutions': '16',
          'class_cond': False,
          'diffusion_steps': 1000,
...
batch_name = 'IsometricSimCity'
steps = 200
width_height_for_512x512_models = [1024, 576]
...
video_init_path = "./init_videos/Mandelbulb1.mp4" #@param {type: 'string'}
...
angle = "0:(0)"
zoom = "0: (1), 10: (1.0)"
translation_x = "0:(0),30:(0.683),60:(0.932),90:(0.250),120:(0.500),150:(-0.430),180:(0.372),210:(0.732),240:(-0.573),270:(-0.812),300:(-0.620),330:(0.403),360:(0.105),390:(0.165),420:(0.343),450:(0.318),480:(-0.578),510:(0.170),540:(-0.481),570:(-0.886),600:(0.915),630:(-0.132),660:(0.222),690:(-0.426),720:(-0.491),750:(-0.325),780:(-0.555),810:(0.796),840:(0.710),870:(0.392),900:(-0.368)"  # 30: (1.25)
translation_y = "0:(0),30:(-0.126),60:(0.426),90:(-0.379),120:(0.356),150:(-0.253),180:(0.362),210:(-0.293),240:(-0.682),270:(-0.391),300:(0.838),330:(-0.289),360:(-0.119),390:(0.691),420:(0.236),450:(-0.401),480:(0.682),510:(-0.164),540:(0.590),570:(-0.128),600:(-0.154),630:(-0.096),660:(0.889),690:(-0.002),720:(0.292),750:(-0.268),780:(0.695),810:(0.972),840:(-0.352),870:(0.999),900:(0.070)"
translation_z = "0:(0),30:(-0.667),60:(0.853),90:(0.566),120:(-0.621),150:(0.716),180:(-0.117),210:(0.506),240:(-0.257),270:(0.946),300:(-0.521),330:(0.881),360:(-0.178),390:(0.518),420:(-0.449),450:(0.328),480:(-0.768),510:(0.598),540:(-0.587),570:(0.198),600:(0.362),630:(0.349),660:(-0.681),690:(-0.449),720:(0.665),750:(0.236),780:(-0.105),810:(-0.860),840:(0.971),870:(-0.637),900:(-0.241)"   # 0: (0.1)
rotation_3d_x = "0: (0)"
rotation_3d_y = "0: (0)"
rotation_3d_z = "0: (0)"
...
#@markdown `frame_skip_steps` will blur the previous frame - higher values will flicker less
# but struggle to add enough new detail to zoom into.
...
#cut_overview="[8]200+[6]200+[4]200+[2]200+[2]200"
#cut_innercut="[0]200+[2]200+[4]200+[6]200+[6]200"
#cut_ic_pow="[0]200+[10]200+[10]200+[10]200+[10]200"
...
transformation_percent = [0.1] #@param

text_prompts = {
    "0": [
        "a highly detailed 3D rendering of the perfect cottage in the video game The Sims"
        "particles, intricately detailed, octane render, 3D render, intricately detailed, beautiful, palace, wood, stained glass",
        "by Kaja Foglio and John Harris and ",
        "harmonic color scheme", "human,person,face,logo,text,signature:-1"
    ]
}
image_prompts = { # 0:['ImagePromptsWorkButArentVeryGood.png:2',],
}
